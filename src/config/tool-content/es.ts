...
export const toolContentEs: Record<string, ToolContent> = {
  ...
  'merge-pdf': {
    title: 'Combinar PDF',
    metaDescription: 'Fusionar PDF gratis en línea: sin registro ni registro.  Utilice nuestra herramienta en línea gratuita para combinar PDF de forma rápida y segura. No se ',
    keywords: [
      'combinar PDF free online',
      'combinar PDF no registration',
      'combinar PDF no sign up',
      'combinar PDF no watermark',
      'combinar PDF browser based',
      'combinar PDF for work',
      'combinar PDF for students',
      'best combinar PDF tool',
      'how to combinar PDF',
      'combinar PDF online free',
      'combinar PDF without software',
      'combinar PDF privacy focused',
      'combinar PDF secure',
      'combinar PDF fast',
      'free combinar PDF tool',
      'online combinar PDF free',
      'combinar PDF tool online',
      'combinar PDF for free',
      'combinar PDF no download',
      'combinar PDF web based',
      'combinar PDF open source',
      'combinar PDF wasm',
      'combinar PDF client side',
      'combinar PDF no upload',
      'combinar PDF instant',
      'combinar PDF high quality',
      'combinar PDF no limit',
      'combinar PDF 2025',
      'combinar PDF guide',
      'combinar PDF tutorial',
    ],
    description: `
    ...
    `,
    howToUse: [
      { step: 1, title: 'Upload Your Files', description: 'Click the upload area or drag and drop your files. All files are processed locally in your browser, ensuring complete privacy. You can combinar PDF no registration, no sign-up needed.' },
      { step: 2, title: 'Configure Settings', description: 'Adjust the tool settings to match your needs. The interface is intuitive and requires no learning curve. Our free combinar PDF tool gives you full control.' },
    ...
    useCases: [
      { title: 'For Office Work', description: 'Professionals use our tool to combinar PDF for reports, proposals, and presentations. Browser-based processing ensures sensitive company documents never leave your device.', icon: 'briefcase' },
      { title: 'For Students', description: 'Students frequently need to combinar PDF for assignments and research papers. Our free tool helps without paying for expensive software subscriptions.', icon: 'academic-cap' },
      { title: 'For Personal Use', description: 'Anyone can use our tool to combinar PDF for personal documents. The simple interface makes it accessible to users of all technical levels.', icon: 'user' },
    ],
    faq: [
      { question: 'Is it really free to combinar PDF online?', answer: 'Yes, our combinar PDF tool is completely free to use. No registration, no sign-up, no credit card required. You can combinar PDF as many times as you need.' },
      { question: 'Is it safe to combinar PDF online?', answer: 'Absolutely. All combinar PDF processing happens locally in your browser. Your files never leave your device and are never uploaded to any server.' },
      { question: 'Do I need to install software to combinar PDF?', answer: 'No software installation is required. Our combinar PDF tool runs entirely in your web browser. It works on Windows, Mac, Linux, and mobile devices.' },
  ...
  'merge-pdf-template': {
    ...
    keywords: [
      'combinar PDF template free online',
      'combinar PDF template no registration',
      'combinar PDF template no sign up',
      'combinar PDF template no watermark',
      'combinar PDF template browser based',
      'combinar PDF template for work',
      'combinar PDF template for students',
      'best combinar PDF template tool',
      'how to combinar PDF template',
      'combinar PDF template online free',
      'combinar PDF template without software',
      'combinar PDF template privacy focused',
      'combinar PDF template secure',
      'combinar PDF template fast',
      'free combinar PDF template tool',
      'online combinar PDF template free',
      'combinar PDF template tool online',
      'combinar PDF template for free',
      'combinar PDF template no download',
      'combinar PDF template web based',
      'combinar PDF template open source',
      'combinar PDF template wasm',
      'combinar PDF template client side',
      'combinar PDF template no upload',
      'combinar PDF template instant',
      'combinar PDF template high quality',
      'combinar PDF template no limit',
      'combinar PDF template 2025',
      'combinar PDF template guide',
      'combinar PDF template tutorial',
    ],
    description: `
    ...
    `,
    howToUse: [
      { step: 1, title: 'Upload Your Files', description: 'Click the upload area or drag and drop your files. All files are processed locally in your browser, ensuring complete privacy. You can combinar PDF template no registration, no sign-up needed.' },
      { step: 2, title: 'Configure Settings', description: 'Adjust the tool settings to match your needs. The interface is intuitive and requires no learning curve. Our free combinar PDF template tool gives you full control.' },
      { step: 3, title: 'Process and Download', description: 'Click the process button and wait a few seconds. Once finished, download your processed file instantly. No email required, no watermarks.' },
    ],
    useCases: [
      { title: 'For Office Work', description: 'Professionals use our tool to combinar PDF template for reports, proposals, and presentations. Browser-based processing ensures sensitive company documents never leave your device.', icon: 'briefcase' },
      { title: 'For Students', description: 'Students frequently need to combinar PDF template for assignments and research papers. Our free tool helps without paying for expensive software subscriptions.', icon: 'academic-cap' },
      { title: 'For Personal Use', description: 'Anyone can use our tool to combinar PDF template for personal documents. The simple interface makes it accessible to users of all technical levels.', icon: 'user' },
    ],
    faq: [
      { question: 'Is it really free to combinar PDF template online?', answer: 'Yes, our combinar PDF template tool is completely free to use. No registration, no sign-up, no credit card required. You can combinar PDF template as many times as you need.' },
      { question: 'Is it safe to combinar PDF template online?', answer: 'Absolutely. All combinar PDF template processing happens locally in your browser. Your files never leave your device and are never uploaded to any server.' },
      { question: 'Do I need to install software to combinar PDF template?', answer: 'No software installation is required. Our combinar PDF template tool runs entirely in your web browser. It works on Windows, Mac, Linux, and mobile devices.' },
      { question: 'Are there any limits on file size or number of files?', answer: 'Our tool supports processing multiple files with a combined size of up to 500MB. There are no daily usage limits or paywalls.' },
      { question: 'Will the output quality be affected?', answer: 'Our tool is designed to maintain the highest possible quality. For merging or splitting, the original quality is preserved exactly.' },
    ],
  },
